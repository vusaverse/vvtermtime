...
#'
#' @export
get_capabilities <- function(semestry, timeout = 30) {
  endpoint <- "/v1/api/capabilities"
  ...
  if (resp$status_code == 200) {
    ...
    stop(paste("Error: Failed to retrieve capability data from the API. Status code:", httr::http_status(resp)$status_code))
  }
}
